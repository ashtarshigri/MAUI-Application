...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"e7f6ac6d-b4e8-4e79-aaec-5589bb95965f\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [22 x i8] c"com.companyname.inovi\00", align 16
...
@__DSOCacheEntry_name.22 = internal constant [20 x i8] c"libaot-INOVI.dll.so\00", align 16
...
@dso_cache = local_unnamed_addr global [458 x %struct.DSOCacheEntry] [
	...
	; 22
	%struct.DSOCacheEntry {
		i64 909801768820208569, ; hash 0xca043e36e8cf3b9, from name: aot-INOVI.dll.so
		i8 0, ; ignore
	...
	; 160
	%struct.DSOCacheEntry {
		i64 7469651977818866786, ; hash 0x67a988e5ddb00462, from name: INOVI
		i8 0, ; ignore
		i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__DSOCacheEntry_name.22, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 383
	%struct.DSOCacheEntry {
		i64 15551907834963861720, ; hash 0xd7d379c742a2a0d8, from name: libaot-INOVI
		i8 0, ; ignore
		i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__DSOCacheEntry_name.22, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 391
	%struct.DSOCacheEntry {
		i64 15881471178962890760, ; hash 0xdc6651e4c4aff008, from name: libaot-INOVI.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__DSOCacheEntry_name.22, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 432
	%struct.DSOCacheEntry {
		i64 17676485035745694346, ; hash 0xf54f7d7c6921528a, from name: aot-INOVI
		i8 0, ; ignore
		i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__DSOCacheEntry_name.22, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 448
	%struct.DSOCacheEntry {
		i64 18228587022249438827, ; hash 0xfcf8f3514a792e6b, from name: INOVI.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__DSOCacheEntry_name.22, i32 0, i32 0), ; name
		i8* null; handle
	}, 
