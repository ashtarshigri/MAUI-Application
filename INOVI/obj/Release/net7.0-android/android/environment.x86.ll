...
@__DSOCacheEntry_name.55 = internal constant [20 x i8] c"libaot-INOVI.dll.so\00", align 1
...
@dso_cache = local_unnamed_addr global [458 x %struct.DSOCacheEntry] [
	...
	; 91
	%struct.DSOCacheEntry {
		i64 945786634, ; hash 0x385f8f0a, from name: INOVI.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__DSOCacheEntry_name.55, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 92
	%struct.DSOCacheEntry {
	...
	; 211
	%struct.DSOCacheEntry {
		i64 2054211179, ; hash 0x7a70c66b, from name: aot-INOVI.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__DSOCacheEntry_name.55, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 217
	%struct.DSOCacheEntry {
		i64 2103845459, ; hash 0x7d662253, from name: libaot-INOVI
		i8 0, ; ignore
		i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__DSOCacheEntry_name.55, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 340
	%struct.DSOCacheEntry {
		i64 3066686838, ; hash 0xb6c9ed76, from name: libaot-INOVI.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__DSOCacheEntry_name.55, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 351
	%struct.DSOCacheEntry {
		i64 3133335481, ; hash 0xbac2e7b9, from name: INOVI
		i8 0, ; ignore
		i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__DSOCacheEntry_name.55, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 368
	%struct.DSOCacheEntry {
		i64 3349710679, ; hash 0xc7a88757, from name: aot-INOVI
		i8 0, ; ignore
		i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__DSOCacheEntry_name.55, i32 0, i32 0), ; name
		i8* null; handle
	}, 
